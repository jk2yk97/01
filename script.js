document.addEventListener('DOMContentLoaded', function () {
    ...
    // 1. Funciones para manejar niveles
    ...
    // 3. Sistema de desbloqueo mejorado
    function checkUnlocking() {
        // Deshabilitar todos los niveles superiores primero
        disableLevel('中文水平二级');
        disableLevel('中文水平三级');
        disableLevel('中文水平四级');
        disableLevel('中文水平五级');
    ...
    // 4. Eventos para los niveles
    allLevels.forEach(li => {
        li.addEventListener('click', function(e) {
            // Ignorar clicks en botones de info
    ...
    // 5. Funcionalidad del Modal (se mantiene igual)
    ...
    // 6. Date Pickers (se mantiene igual)
